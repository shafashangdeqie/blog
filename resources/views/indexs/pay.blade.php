     ...
     <div class="dingdanlist" onClick="window.location.href='address.html'">
      <table>
       ...
       <tr>
        ...
        <td class="dingimg" width="15%"><img src="http://www.uploads.com/{{$val->file}}" /></td>
        <td width="50%">
         <h3>{{$val->username}}</h3>
       ...
       <tr>
        <th colspan="3"><strong class="orange">¥{{$val->pirce}}</strong></th>
       </tr>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%">总计：<strong class="orange">¥{{$val->pirce}}</strong></td>
       <td width="40%"><a href="successdo{{$val->p_id}}" class="jiesuan">提交订单</a></td>
      </tr>
      @endforeach
     </table>
    </div><!--gwcpiao/-->
