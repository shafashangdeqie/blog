...
<html lang="zh-cn">
  <head>
    ...
    <title>三级分销</title>
    <link rel="shortcut icon" href="shop/shop/images/favicon.ico" />
    ...
    <div class="maincont">
     <div class="userName">
      <dl class="names">
       ...
       <dd>
        <h3><b style="color:pink">{{$email}}</b></h3>
       </dd>
     ...
     <ul class="userNav">
      ...
      <div class="state">
         <dl>
          <dt><a href="success"><img src="shop/images/user1.png" /></a></dt>
          <dd><a href="success">待支付</a></dd>
         </dl>
         <dl>
          <dt><a href="order"><img src="shop/images/user2.png" /></a></dt>
          <dd><a href="order">代发货</a></dd>
         </dl>
         <dl>
          <dt><a href="order"><img src="shop/images/user3.png" /></a></dt>
          <dd><a href="order">待收货</a></dd>
         </dl>
         <dl>
          <dt><a href="order"><img src="shop/images/user4.png" /></a></dt>
